package com.home.wather.interfaces;

/**
 * Interface for a data structure that efficiently tracks the warmest (most recently accessed) key.
 */
public interface WarmestDataStructureInterface {
    ...
    /**
     * This method returns the value to which the specified key is mapped, or null if this map contains no
     * mapping for the key.
     * Complexity: O(1)
     * 
